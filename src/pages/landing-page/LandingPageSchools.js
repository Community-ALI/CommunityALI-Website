...
function LandingPageSchools() {
    return(
        <div className="schools-container">
            ...
            <a className="schools-box" href="" aria-label="School of Agriculture">
                <div className="icon"> 
            ...
            <a className="schools-box" href="" aria-label="School of Arts, Performance, & the Humanities">
                <div className="icon"> 
            ...
            <a className="schools-box" href="" aria-label="School of Behavioral and Social Science">
                <div className="icon"> 
            ...
            <a className="schools-box" href="" aria-label="School of Business and Computing">
                <div className="icon"> 
            ...
            <a className="schools-box" href="" aria-label="School of Fitness and Health Professions ">
                <div className="icon"> 
            ...
            <a className="schools-box" href="" aria-label="School of Industry and Trades">
                <div className="icon"> 
            ...
            <a className="schools-box" href="" aria-label="School of Language Arts and Education">
                <div className="icon"> 
            ...
            <a className="schools-box" href="" aria-label="School of Public Safety">
                <div className="icon"> 
            ...
            <a className="schools-box" href="" aria-label="School of Science and Mathematics">
                <div className="icon"> 
