        ...
        <div>
            ...
            <div className="service-categories-container">
                ...
                <a className="category-container" href="/add-club">
                    <p class="category-header"> Add an MJC Club</p>
                ...
                <a className="category-container" href="/add-event">
                    <p class="category-header">Add a Local Event</p>
                    <p class="category-text"> 
                ...
                <a className="category-container" href="/add-volunteer">
                    <p class="category-header">Add Volunteering</p>
                    <p class="category-text"> 
                ...
                <a className="category-container" href="/add-intern">
                    <p class="category-header">Add an Internship</p>
                    <p class="category-text"> 
