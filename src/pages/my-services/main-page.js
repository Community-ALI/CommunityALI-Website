    ...
    <div className="flex content-center px-[5%] lr:flex-col lr:items-center sm:mb-[30px]">
      ...
      >
        ...
        <div className="flex justify-between w-[100%] px-[30px] xlr:px-[20px] md:flex-col md:px-[10px] md:py-[10px]">
          ...
          overflow-ellipsis w-[60%] xxlr:text-start xxlr:max-w-[400px] xlr:max-w-[300px] md:w-[100%] md:text-center md:line-clamp-2 sm:text-[90%] xms:text-[60%]"
          >
            {service.title}
          </div>
          <Notifications
          ...
          <div className="flex items-center flex-wrap lr:justify-end md:justify-center md:mt-[10px] sm:hidden">
            ...
            <a href={`view-applicants?service=${service.title}`}>
              <img
                className="h-[50px] w-[50px] mr-[30px] xlr:h-[40px] xlr:w-[40px] xxlr:mr-[0px] lr:h-[35px] lr:w-[35px] md:h-[30px] md:w-[30px] transition duration-300 ease-out hover:scale-[1.1]"
