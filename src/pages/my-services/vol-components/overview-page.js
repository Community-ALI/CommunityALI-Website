    ...
    <div>
      <div className="service-info-container">
        <div className="file-container" id={fileContainerID}>
          <header>Volunteer Photo Uploader</header>
        ...
        <div className="service-details">
          <div className="service-author">
            <input
              type="text"
              placeholder="Organizer of the Project"
          ...
          <div className="service-header">Volunteer Details</div>

          <div>
            <u> Time: </u>
            <input
              type="text"
              placeholder="Include start and end time (approx)"
              onChange={handleFormChange}
              name="time"
              value={formData.time || ""}
          ...
          <div>
            ...
            <input
              type="text"
              placeholder="Include building or place"
              onChange={handleFormChange}
              name="location"
      ...
      <div className="service-description">
        <textarea
          rows="5"
          type="text"
          placeholder="Include a description of what the volunteer activity consists of..."
          onChange={handleFormChange}
          name="description"
