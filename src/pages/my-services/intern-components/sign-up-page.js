        ...
        <div>
            <div className="sign-up-form">
              <div id="form" className="sign-up-form-boxes">
                <div className="service-header" id="sign-up-header">Sign up to this Internship Today!</div>
            ...
            <div className="authorization-container">
                ...
                I understand that this application will be subject to review, in which any inappropriate content associated with the internship or its
                organizers will result in immediate termination of the internship from the platform. I understand that there is no tolerance for any discrimination
