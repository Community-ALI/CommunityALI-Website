              ...
              <form onSubmit={handleSubmit} method="POST" id="form">
                <div className="form-container">
                  <div className="text-container" id="name-container">
                    ...
                    <input className="service-info-text text-black" type="text" 
                      placeholder="First and Last Name" id="name" name="name" 
                      ref={nameRef} required /><br />
                  ...
                  <div className="text-container" id="email-container">
                    ...
                    <input className="service-info-text text-black" type="email" 
                      placeholder="School Email" id="email" name="email" 
                      ref={emailRef} required /><br />
