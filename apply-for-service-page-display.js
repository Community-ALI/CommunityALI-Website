...
const SearchResult = function(props) {
  const service = props.service;
   return React.createElement('div', { className: 'result-container', id: service.title},
    ...
    React.createElement('div', { className: 'result-author' }, service.author),
    React.createElement('div', { className: 'button-container' },
        React.createElement('a', { className: 'button', href: "/apply-for-service.html?service=" + service.title}, 'Click for more info')
    )
  );
};
